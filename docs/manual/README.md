...
| 4 | [Editor Keyboard Shortcuts](./04-editor-shortcuts.md) | Notion / Obsidian–style formatting shortcuts in the CodeMirror editor: bold, italic, code, links, lists, headings, and what's intentionally deferred. |
