...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\x80\t\n" +
	...
	"\bwebhooks\x18\x01 \x03(\v2\x19.memos.api.v1.UserWebhookR\bwebhooks\x1aO\n" +
	"\x11LastOpenedSetting\x12!\n" +
	"\tworkspace\x18\x01 \x01(\tB\x03\xe0A\x01R\tworkspace\x12\x17\n" +
	"\x04memo\x18\x02 \x01(\tB\x03\xe0A\x01R\x04memo\"P\n" +
	"\x03Key\x12\x13\n" +
