...
export type Memo = Message<"memos.api.v1.Memo"> & {
   ...
   *
   * @generated from field: optional memos.api.v1.DocAnchor doc_anchor = 24;
   */
  docAnchor?: DocAnchor | undefined;

  /**
   * Optional. Set when this memo is a comment anchored to a text range within
   * an EPUB attachment.
   *
   * @generated from field: optional memos.api.v1.EpubAnnotation epub_annotation = 26;
   */
  epubAnnotation?: EpubAnnotation | undefined;
   ...
   *
   * @generated from field: map<string, string> node_overlays = 25;
   */
  nodeOverlays: { [key: string]: string };
};
...
export type PdfAnnotation = Message<"memos.api.v1.PdfAnnotation"> & {
   ...
   *
   * @generated from field: string text_exact = 8;
   */
  textExact: string;
   ...
   *
   * @generated from field: string text_prefix = 9;
   */
  textPrefix: string;

  /**
   * @generated from field: string text_suffix = 10;
   */
  textSuffix: string;
   ...
   *
   * @generated from field: bool underline = 12;
   */
  underline: boolean;
};
 ...
 *
 * @generated from message memos.api.v1.DocAnchor
 */
export type DocAnchor = Message<"memos.api.v1.DocAnchor"> & {
  /**
   ...
   *
   * @generated from field: string heading_slug = 1;
   */
  headingSlug: string;
   ...
   *
   * @generated from field: string text_exact = 3;
   */
  textExact: string;
   ...
   *
   * @generated from field: string text_prefix = 4;
   */
  textPrefix: string;

  /**
   * @generated from field: string text_suffix = 5;
   */
  textSuffix: string;
...
/**
 * Describes the message memos.api.v1.DocAnchor.
 * Use `create(DocAnchorSchema)` to create a new message.
 */
export const DocAnchorSchema: GenMessage<DocAnchor> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 4);

/**
 * @generated from message memos.api.v1.EpubAnnotation
 */
export type EpubAnnotation = Message<"memos.api.v1.EpubAnnotation"> & {
  /**
   * The name of the attachment this annotation is anchored to.
   * Format: attachments/{uid}
   *
   ...
   *
   * @generated from field: string cfi_range = 2;
   */
  cfiRange: string;
   ...
   *
   * @generated from field: string text_snippet = 3;
   */
  textSnippet: string;
...
/**
 * Describes the message memos.api.v1.EpubAnnotation.
 * Use `create(EpubAnnotationSchema)` to create a new message.
 */
export const EpubAnnotationSchema: GenMessage<EpubAnnotation> = /*@__PURE__*/
...
export const MemoRelation_MemoSchema: GenMessage<MemoRelation_Memo> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 15, 0);
...
export const MemoRelation_TypeSchema: GenEnum<MemoRelation_Type> = /*@__PURE__*/
  enumDesc(file_api_v1_memo_service, 15, 0);
...
export const MemoHistory_AttachmentSchema: GenMessage<MemoHistory_Attachment> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 32, 0);
