...
export type UserSetting = Message<"memos.api.v1.UserSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.UserSetting.RagSearchSetting rag_search_setting = 8;
     */
    value: UserSetting_RagSearchSetting;
 ...
 *
 * @generated from message memos.api.v1.UserSetting.RagSearchSetting
 */
export type UserSetting_RagSearchSetting = Message<"memos.api.v1.UserSetting.RagSearchSetting"> & {
  /**
   * Max documents to return. Zero falls back to the engine default (20).
   *
   * @generated from field: int32 max_result_docs = 1;
   */
  maxResultDocs: number;
...
/**
 * Describes the message memos.api.v1.UserSetting.RagSearchSetting.
 * Use `create(UserSetting_RagSearchSettingSchema)` to create a new message.
 */
export const UserSetting_RagSearchSettingSchema: GenMessage<UserSetting_RagSearchSetting> = /*@__PURE__*/
...
export const UserSetting_LastOpenedSettingSchema: GenMessage<UserSetting_LastOpenedSetting> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 13, 5);
...
export enum UserSetting_Key {
   ...
   *
   * @generated from enum value: RAG_SEARCH = 7;
   */
  RAG_SEARCH = 7,
}
